...
(function ($) {
  ...
  // Banner Three slider area start here ***
  if ($(".banner-slider-home-3").length) {
    var swiper = new Swiper(".banner-slider-home-3", {
      loop: true,
      freemode: true,
      slidesPerView: 1,
      spaceBetween: 30,
  ...
  // instagram slider area start here ***
  if ($(".instagram-slider").length) {
    var swiper = new Swiper(".instagram-slider", {
      slidesPerView: 6,
      spaceBetween: 35,
  ...
  // instagram slider area end here ***

  // price slider two area start here ***
  if ($(".price-slider-two").length) {
    var swiper = new Swiper(".price-slider-two", {
      slidesPerView: 2,
      spaceBetween: 42,
      loop: true,
      speed: 1500,
      ...
      navigation: {
        nextEl: ".price-slider-two-next",
        prevEl: ".price-slider-two-prev",
      },
  ...
  // testimonial slider two area start here ***
  if ($(".testimonial-slide-two").length) {
    var swiper = new Swiper(".testimonial-slide-two", {
      slidesPerView: 3, // show 3 slides on desktop
      spaceBetween: 42,
      loop: true,
      speed: 1500,
      centeredSlides: true, // center slide is "active"
      autoplay: {
        delay: 5000,
        disableOnInteraction: false,
      },
  ...
  // testimonial slider two area end here ***
  ...
  if ($(".team-slider").length) {
    var swiper = new Swiper(".team-slider", {
      ...
      pagination: {
        ...
        clickable: true, // so bullets can be clicked
      },
      breakpoints: {
        320: {
          slidesPerView: 1,
  ...
  if($('.price-range-slider2').length){
    ...
    $( "input.property-amount" ).val( $( ".price-range-slider2" ).slider( "values", 0 ) + " - $" + $( ".price-range-slider2" ).slider( "values", 1 ) );
  }
  ...
  //Tabs Box
  if ($('.tabs-box').length) {
    $('.tabs-box .tab-buttons2 .tab-btn').on('click', function (e) {
      e.preventDefault();
      var target = $($(this).attr('data-tab'));
      ...
      if ($(target).is(':visible')) {
        ...
        target.parents('.tabs-box').find('.tab-buttons2').find('.tab-btn').removeClass('active-btn');
        $(this).addClass('active-btn');
